...
export default function Gallery() {
  ...
  const images = [
    ...
    "https://lh3.googleusercontent.com/pw/AP1GczOQ9O4Dixs56B6n59oZTXbhnM4niVsWXCqhH9joEcPqdKD93qcdlTPNu1BVbUjNRtBfLf84qxQ0P-zgjYX-y9NVWkGL7extZzfmEcbwh5lBLJHVhT8unnc98e-NoTn0XlcoJs2rcBCGjdPT-k1D6evb=w2048-h1536-s-no?authuser=0",
    "https://lh3.googleusercontent.com/pw/AP1GczO_nUqncVVa9ripitLeU79xB7H3FRGy7MMOuayyaGrizM3kv-Qqwf9vZWCcySeWv1LYHfOl29elfDh3kIA0cf9JriWgyA-KtbVkNOUcovBmM51_K2X5W3cXzQGkWNZi91VzfrbvdP5A_qsGII6lWTQO=w1024-h765-s-no?authuser=0"
  ];
